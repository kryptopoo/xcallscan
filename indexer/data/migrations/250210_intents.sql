...
CREATE INDEX idx_messages_intents_order_id ON public.messages(intents_order_id);

-- Update Trigger: message_trigger
...
BEGIN
  ...
  payload := json_build_object(
    ...
    'intents_order_id',rec.intents_order_id,
    'intents_order_detail',rec.intents_order_detail,
