const getAssets = async () => {
    const res = await fetch(`https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=icon,binancecoin,ethereum,bitcoin&order=market_cap_desc&per_page=100&page=1&sparkline=false`, {
        next: { revalidate: 600 }
    })
